...
def boar_brawl(player_score, opponent_score):
    ...
    points = 3 * abs(player_num - opponent_num)
    if points == 0:
        points = 1
    return points
    # END PROBLEM 2
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    final_score = sus_points(simple_score)
    return final_score
    # END PROBLEM 4
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    dice_num = 1
    for i in range(10):
        each_average = make_averaged(roll_dice, times_called)(i + 1, dice)
        if each_average > max_score:
            max_score = each_average
            dice_num = i + 1
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    updated_score = boar_brawl(score, opponent_score)
    if updated_score >= threshold:
        num_rolls = 0
...
def final_strategy(score, opponent_score):
    ...
    This strategy will roll 0 when the points given is more than the average of rolling 6 dice
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    six_average = make_averaged(roll_dice)(6)
    updated_score = sus_update(0,score,opponent_score)
    if updated_score -score >= six_average:
        return 0
    else:
        return 6
